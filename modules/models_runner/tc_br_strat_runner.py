...
class TC_BR_Generic_Strat_Runner(metaclass=ABCMeta):
    def __init__(self, oracle):
        ...
        self.models_runner = TC_BR_Runner()
        self.evals_df = None
    ...
    def get_vsm_model(self):
        return self.vsm_model
...
class TC_BR_Vol_Strat_Runner(TC_BR_Generic_Strat_Runner):
    def __init__(self):
        super().__init__(fd.Tc_BR_Oracles.read_oracle_volunteers_df())
...
class TC_BR_Exp_Strat_Runner(TC_BR_Generic_Strat_Runner):
    def __init__(self):
        super().__init__(fd.Tc_BR_Oracles.read_oracle_expert_df())
...
class TC_BR_Exp_Vol_Union_Strat_Runner(TC_BR_Generic_Strat_Runner):
    def __init__(self):
        super().__init__(fd.Tc_BR_Oracles.read_oracle_expert_volunteers_union_df())
...
class TC_BR_Exp_Vol_Intersec_Strat_Runner(TC_BR_Generic_Strat_Runner):
    def __init__(self):
        super().__init__(fd.Tc_BR_Oracles.read_oracle_expert_volunteers_intersec_df())

# script to get additional information about the bugs of days 01/06/2016 and 02/06/2016 needed for analysis
...
BUGS_FILE_PATH = '/home/guilherme/anaconda3/envs/trace-link-recovery-study/data/mozilla_firefox_v2/firefoxDataset/docs_english/BR/all_bugs_add_info_2.csv'
...
for offset_ in range(0, 1000, LIMIT): # 0, 7000, 1000
    if len(args) < 8:
        args = args + [offset_]
    else:
        args[7] = offset_
